---
title: "linutil Agentic Developer Experience"
project: "linutil"
scope: personal
status: active
updated: 2026-06-05
...
- **Active Task**: Updates to your current task go into `ACTIVE_TASK.md` at the project root. Update this at the end of every session.
- **Machine State**: Updates to the versioned machine state go into `STATE.json` at the project root.
